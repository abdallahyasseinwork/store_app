...
import 'package:firsttest/model/settings/addratingmodel.dart';
import 'package:firsttest/model/settings/ratereviewmodel.dart';
              ...
              if (snapshot.hasData) {
                return Scaffold(
                  ...
                  floatingActionButton: finaldata!.checkReviewExist
                      ...
                      : SizedBox(),
                  body: finaldata!.data!.isNotEmpty
                      ? ListView.separated(
