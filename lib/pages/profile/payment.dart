...
import 'package:single_ecommerce/payment/razorpay.dart';
import 'package:single_ecommerce/payment/flutterwave.dart';
import 'package:single_ecommerce/payment/paystack.dart';
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          setState(() {
                            ...
                            print(secret_key);
                            print(
                                "fgfjhj,hk,  ${paymentlist!.paymentmethods![index].publicKey}");
                          });
                        },
                        child: SizedBox(
                          height: 7.h,
