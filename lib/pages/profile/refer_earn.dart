                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          Share.share(
                            currencyposition == "1"
                                ? '${LocaleKeys.Use_this_code.tr()} $user_refer_code ${LocaleKeys.to_register_with.tr()} ${LocaleKeys.ecommerce_User.tr()} ${LocaleKeys.get_bonus_amount.tr()} $currency$_reffer_amount \n $Androidapplink \n $Iosapplink   '
                                : '${LocaleKeys.Use_this_code.tr()} $user_refer_code ${LocaleKeys.to_register_with.tr()} ${LocaleKeys.ecommerce_User.tr()} ${LocaleKeys.get_bonus_amount.tr()} $_reffer_amount$currency \n $Androidapplink \n $Iosapplink  ',
                          );
                        },
                      ),
                    )
