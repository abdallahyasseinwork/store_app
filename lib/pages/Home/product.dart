...
import 'package:firsttest/model/home/itemdetailsmodel.dart';
...
import 'package:firsttest/pages/favorite/showvariation.dart';
...
class _ProductState extends State<Product> {
  ...
  Future itemdetailsAPI(type) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  log(itemdata!.data!.availableQty.toString());
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: FutureBuilder(
        future: isproductdetail == true ? itemdetailsAPI(0) : null,
